...
;(async () => {
    ...
    */
    ...
    /* Step 2
       Transfer 100000000umelc from account 1 to account 2
    */
    console.log(chalk.cyan('2. Transfer 1000000000umelc from account 1 to account 2'))
    const transfeTx = mele.bank
        .transfer(recAddress, [{ denom: 'umelc', amount: '1000000000' }])

    const fee = await transfeTx.calculateFees()
    console.log(
    ...
    const txEvents = await transfeTx.sendTransaction()
    console.log(
