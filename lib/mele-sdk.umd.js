    ...
    ***************************************************************************** */
    ...
    class StakingQuery {
        ...
        getRedelegations(delegatorAddress, srcValidatorAddress, dstValidatorAddress) {
            ...
            return this._transport.query([], JSON.stringify({ DelegatorAddr: delegatorAddress, SrcValidatorAddr: srcValidatorAddress, DstValidatorAddr: dstValidatorAddress }), QueryPath, RedelegationsPath);
        }
