(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    class MintQuery {
        ...
        getInflation() {
            const QueryPath = Keys$2.Query.QueryPath;
            const InflationPath = Keys$2.Query.InflationPath;
            return this._transport.query([], '', QueryPath, InflationPath);
        }
        getAnnualProvisions() {
            const QueryPath = Keys$2.Query.QueryPath;
            const AnnualProvisionsPath = Keys$2.Query.AnnualProvisionsPath;
    ...
    class SlashingQuery {
        ...
        getSigningInfo(consAddress) {
            const QueryPath = Keys$3.Query.QueryPath;
            const SigningInfoPath = Keys$3.Query.SigningInfoPath;
            return this._transport.query([], JSON.stringify({
        ...
        getSigningInfos() {
            const QueryPath = Keys$3.Query.QueryPath;
            const SigningInfosPath = Keys$3.Query.SigningInfosPath;
            return this._transport.query([], JSON.stringify({
                Page: '1',
                Limit: '0',
    ...
    class StakingQuery {
        ...
        getValidators() {
            ...
            const ValidatorsPath = Keys$4.Query.ValidatorsPath;
            return this._transport.query([], JSON.stringify({
                Status: 'Bonded',
                Page: '1',
                Limit: '1000',
        ...
        getValidatorUnbondingDelegations(address) {
            const QueryPath = Keys$4.Query.QueryPath;
            const ValidatorUnbondingDelegationsPath = Keys$4.Query.ValidatorUnbondingDelegationsPath;
        ...
        getDelegation(delegatorAddress, validatorAddress) {
            const QueryPath = Keys$4.Query.QueryPath;
            const DelegationPath = Keys$4.Query.DelegationPath;
        ...
        getUnbondingDelegation(delegatorAddress, validatorAddress) {
            const QueryPath = Keys$4.Query.QueryPath;
            const UnbondingDelegationPath = Keys$4.Query.UnbondingDelegationPath;
        ...
        getDelegatorDelegations(delegatorAddress) {
            const QueryPath = Keys$4.Query.QueryPath;
            const DelegatorDelegationsPath = Keys$4.Query.DelegatorDelegationsPath;
        ...
        getDelegatorUnbondingDelegations(delegatorAddress) {
            const QueryPath = Keys$4.Query.QueryPath;
            const DelegatorUnbondingDelegationsPath = Keys$4.Query.DelegatorUnbondingDelegationsPath;
        ...
        getRedelegations(delegatorAddress, srcValidatorAddress, dstValidatorAddress) {
            const QueryPath = Keys$4.Query.QueryPath;
            const RedelegationsPath = Keys$4.Query.RedelegationsPath;
            return this._transport.query([], JSON.stringify({
        ...
        getDelegatorValidators(delegatorAddress) {
            const QueryPath = Keys$4.Query.QueryPath;
            const DelegatorValidatorsPath = Keys$4.Query.DelegatorValidatorsPath;
        ...
        getDelegatorValidator(delegatorAddress, validatorAddress) {
            const QueryPath = Keys$4.Query.QueryPath;
            const DelegatorValidatorPath = Keys$4.Query.DelegatorValidatorPath;
        ...
        getHistoricalInfo(height) {
            const QueryPath = Keys$4.Query.QueryPath;
            const HistoricalInfoPath = Keys$4.Query.HistoricalInfoPath;
        ...
        getPool() {
            const QueryPath = Keys$4.Query.QueryPath;
            const PoolPath = Keys$4.Query.PoolPath;
    ...
    class TreasuryQuery {
        ...
        getTreasury() {
            const QueryPath = Keys$5.Query.QueryPath;
            const TreasuryPath = Keys$5.Query.TreasuryPath;
            return this._transport.query([], '', QueryPath, TreasuryPath);
        }
        getOperators() {
            const QueryPath = Keys$5.Query.QueryPath;
            const OperatorsPath = Keys$5.Query.OperatorsPath;
            return this._transport.query([], '', QueryPath, OperatorsPath);
        }
        getDisbursements() {
            const QueryPath = Keys$5.Query.QueryPath;
            const DisbursementsPath = Keys$5.Query.DisbursementsPath;
            return this._transport.query([], '', QueryPath, DisbursementsPath);
        }
        getBurns() {
            const QueryPath = Keys$5.Query.QueryPath;
            const BurnsPath = Keys$5.Query.BurnsPath;
    ...
    class Query {
        ...
        getAccountInfo(address) {
            const AuthModuleQueryPath = Keys$6.Query.AuthModuleQueryPath;
            const AccountPath = Keys$6.Query.AccountPath;
