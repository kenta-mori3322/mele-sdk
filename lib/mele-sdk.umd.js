(function (global, factory) {
	...
	const getHash256 = input => {
	    let sha256$$1 = sha256;
	    let hash2 = sha256$$1.update(input);
	    return hash2.array();
	};
	...
	let { Buffer: Buffer$2 } = safeBuffer;
	...
	const encodeJsonSlice = (tmpInstance) => {
	    ...
	    return Buffer$2.from(tmpInstance).toString('base64')
	};
	...
	let { Buffer: Buffer$3 } = safeBuffer;
	...
	const decodeJsonSlice = (value) => {
	    return Array.from(Buffer$3.from(value, 'base64'))
	};
	...
	const Signature = src_3.create('signature', [
	    {
	        name: 'pub_key',
