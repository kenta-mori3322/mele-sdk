(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('js-sha256'), require('readable-stream'), require('bip32'), require('bip39')) :
    typeof define === 'function' && define.amd ? define(['exports', 'js-sha256', 'readable-stream', 'bip32', 'bip39'], factory) :
    (factory((global.mele = {}),global.jsSha256,null,global.bip32,global.bip39));
}(this, (function (exports,jsSha256,readableStream,bip32,bip39) { 'use strict';

    jsSha256 = jsSha256 && jsSha256.hasOwnProperty('default') ? jsSha256['default'] : jsSha256;
    readableStream = readableStream && readableStream.hasOwnProperty('default') ? readableStream['default'] : readableStream;
    ...
    ***************************************************************************** */
    ...
    class TreasuryQuery {
        ...
        getTreasury() {
            const QueryPath = Keys$6.Query.QueryPath;
            const TreasuryPath = Keys$6.Query.TreasuryPath;
            return this._transport.query([], '', QueryPath, TreasuryPath);
        }
        getOperators() {
            const QueryPath = Keys$6.Query.QueryPath;
            const OperatorsPath = Keys$6.Query.OperatorsPath;
            return this._transport.query([], '', QueryPath, OperatorsPath);
        }
        getDisbursements() {
            const QueryPath = Keys$6.Query.QueryPath;
            const DisbursementsPath = Keys$6.Query.DisbursementsPath;
            return this._transport.query([], '', QueryPath, DisbursementsPath);
        }
        getBurns() {
            const QueryPath = Keys$6.Query.QueryPath;
            const BurnsPath = Keys$6.Query.BurnsPath;
    ...
    class Query {
        ...
        getAccountInfo(address) {
            const AuthModuleQueryPath = Keys$7.Query.AuthModuleQueryPath;
            const AccountPath = Keys$7.Query.AccountPath;
    ...
    */
    ...
    var registeredType = createCommonjsModule(function (module) {
    ...
    let privObject = Symbol("privateObj");
     ...
     class RegisteredType {
        ...
        calculateDisambAndPrefix() {
            let nameHash = utils$1.getHash256(this.name);
    ...
    var registeredType_1 = registeredType.RegisteredType;
    ...
    var typeFactory = createCommonjsModule(function (module) {
    ...
    if (commonjsRequire.main === module) {
        ...
        console.log(reflect.typeOf(obj));



    }
    });
    var typeFactory_1 = typeFactory.create;
    var typeFactory_2 = typeFactory.isExisted;
    ...
    const typeOf = instance => {
        ...
        if( instance in Types$1 ) return Types$1[instane]
    ...
    const ownKeys = instance => {    
        if( !typeFactory.isExisted(typeOf(instance)) ) return []//throw new TypeError("instance must be amino type") //remember to check it again
    ...
    const typeToTyp3 = (type, opts) => {
        switch (type) {
            case Types$1.Interface:
                return WireType$1.ByteLength
            case Types$1.ArrayInterface:
            case Types$1.ByteSlice:
            case Types$1.ArrayStruct:   
                return WireType$1.ByteLength
            case Types$1.String:
                return WireType$1.ByteLength
            case Types$1.Struct:
            ...
            case Types$1.Int64:
                if (opts.binFixed64) {                
                    return WireType$1.Type8Byte
                } else {
                    return WireType$1.Varint
                }
            case Types$1.Int32:
                if (opts.binFixed32) {
                    return WireType$1.Type4Byte
                } else {
                    return WireType$1.Varint
                }
            case Types$1.Time:
    ...
    var encode$2 = function encode (v, b, o) {
      v = v >= 0 ? v*2 : v*-2 - 1;
      var r = varint.encode(v, b, o);
      encode.bytes = varint.encode.bytes;
      return r
    };
    var decode$2 = function decode (b, o) {
    ...
    const encodeSignedVarint = input => {
        let buf = signedVarint.encode(input);
        return buf;
    };
    ...
    const encodeInt64 = input => {
        let buff = Buffer(8);
        int53_1.writeInt64LE(input, buff, 0);
    ...
    const encodeTime = time => {
        ...
        if (s != 0) {
            if (s < utils$1.MinSecond && s >= utils$1.MaxSecond) {
                throw new RangeError(`Second have to be >= ${utils$1.MinSecond}, and <: ${utils$1.MaxSecond}`)
            }
    ...
    var encoder_1 = encoder.encodeSignedVarint;
    var encoder_2 = encoder.encodeFieldNumberAndType;
    var encoder_3 = encoder.encodeString;
    var encoder_4 = encoder.encodeInt8;
    var encoder_5 = encoder.encodeInt16;
    var encoder_6 = encoder.encodeInt32;
    var encoder_7 = encoder.encodeInt64;
    var encoder_8 = encoder.encodeSlice;
    var encoder_9 = encoder.encodeBoolean;
    var encoder_10 = encoder.encodeUVarint;
    var encoder_11 = encoder.encodeTime;
    ...
    const compositionTypes = [Types$2.Struct, Types$2.Interface, Types$2.ArrayStruct,
        Types$2.Interface
    ];
    ...
    const encodeBinary = (instance, type, opts, isBare = true) => {
        ...
        */
        ...
        switch (type) {
            ...
            case Types$2.ByteSlice:
                {
                    data = encoder.encodeSlice(tmpInstance);
                    break;
                }

            case Types$2.ArrayStruct:
                {
                    data = encodeBinaryArray(tmpInstance, Types$2.ArrayStruct, opts, isBare);
                    break;
                }

            case Types$2.ArrayInterface:
                {
                    data = encodeBinaryArray(tmpInstance, Types$2.ArrayInterface, opts, isBare);
                    break;
                }

            case Types$2.Interface:
                {
    ...
    const encodeBinaryField = (typeInstance, idx, type, opts) => {
        let encodeData = null;
        if (type == Types$2.ArrayStruct || type == Types$2.ArrayInterface) {
            encodeData = encodeBinaryArray(typeInstance, type, opts, true, idx);
        } else if (type == Types$2.Time) {
            ...
            let encodeField = encoder.encodeFieldNumberAndType(idx + 1, reflect.typeToTyp3(type, opts));
    ...
    const encodeBinaryArray = (instance, arrayType, opts, isBare = true, idx = 0) => {
        ...
        for (let i = 0; i < instance.length; ++i) {
            let item = instance[i];
            let encodeField = encoder.encodeFieldNumberAndType(idx + 1, reflect.typeToTyp3(Types$2.ArrayStruct, opts));        
            let itemType = arrayType == Types$2.ArrayInterface ? Types$2.Interface : Types$2.Struct;
    ...
    const encodeTime = (time, idx, opts, isBare) => {
        ...
        let encodeField = encoder.encodeFieldNumberAndType(idx + 1, reflect.typeToTyp3(Types$2.Struct , opts )); //notice: use Types.Struct -> Time is a special of Struct
    ...
    const decodeSignedVarint = input => {
        ...
        let buf = signedVarint.decode(input);
        
        return {
            data: buf,
            byteLength: signedVarint.decode.bytes
        };
    };
    ...
    const decodeUVarint = input => {
        ...
        if( !input.length ) throw new TypeError("Can not decodeSignedVarint invalid input length")
        let buf = varint.decode(input);

        return {
            data: buf,
            byteLength: varint.decode.bytes
        };    
    };
    ...
    const decodeInt64 = input => {
        ...
        var number = int53_1.readInt64LE(buf, offset);
    ...
    var decoder_1 = decoder.decodeUVarint;
    var decoder_2 = decoder.decodeInt8;
    var decoder_3 = decoder.decodeInt16;
    var decoder_4 = decoder.decodeInt64;
    var decoder_5 = decoder.decodeString;
    var decoder_6 = decoder.decodeTime;
    var decoder_7 = decoder.decodeFieldNumberAndType;
    var decoder_8 = decoder.decodeSlice;
    ...
    const decodeBinary = (bz, instance, type, opts, isBare = true) => {
        ...
        switch (type) {
            ...
            case Types$3.ArrayStruct: {
                decodedData = decodeBinaryArray(bz, Types$3.ArrayStruct, instance, opts, isBare);
                break;
            }

            case Types$3.ArrayInterface: {
                decodedData = decodeBinaryArray(bz, Types$3.ArrayInterface, instance, opts, isBare);
                break;
            }

            case Types$3.ByteSlice: {
                decodedData = decoder.decodeSlice(bz);
                break;
            }

            case Types$3.Interface: {
    ...
    const decodeBinaryField = (bz, idx, type, instance, opts, isBare) => {
        ...
        if (type == Types$3.ArrayStruct || type == Types$3.ArrayInterface) {
            ...
            let expectedTyp3 = reflect.typeToTyp3(type, opts);
            let buffTyp3 = decodedFieldtype.type; //Reflection.typeToTyp3(decodedFieldtype.type, {})
            let excludeTypes = [WireType$2.Interface, WireType$2.Struct, WireType$2.ByteSlice];
            if (expectedTyp3 != buffTyp3 /*WireMap[decodedFieldtype.type]*/ //also check that interface can be any time
                &&
                !excludeTypes.includes(WireMap$1[type]) && !excludeTypes.includes(WireMap$1[decodedFieldtype.type])) {
    ...
    const decodeBinaryArray = (bz, arrayType, instance, opts, isBare = true, idx = 0) => {
        ...
        let itemType = arrayType == Types$3.ArrayInterface ? Types$3.Interface : Types$3.Struct;
    ...
    const verifyPrefix = (bz, instance) => {
        ...
        if (instance.info) {
            if (instance.info.registered) {
                ...
                if (!utils$1.isEqual(bz.slice(0, 4), instance.info.prefix)) {
    ...
    let { Buffer: Buffer$9 } = safeBuffer;
    ...
    const encodeJson = (instance, type) => {
        ...
        if (type != Types$4.Struct && type != Types$4.Interface && type != Types$4.Array) { //only get the first property with type != Struct        
            let keys = reflect.ownKeys(instance);
        ...
        switch (type) {
            ...
            case Types$4.ByteSlice:
                {
                    return encodeJsonSlice(tmpInstance)
                }

            case Types$4.ArrayStruct:
                {
                    return encodeJsonArray(tmpInstance, Types$4.ArrayStruct)
                }
            case Types$4.ArrayInterface:
                {
                    return encodeJsonArray(tmpInstance, Types$4.ArrayInterface)
                }
            case Types$4.Interface:
                {
    ...
    const encodeJsonArray = (instance, arrayType) => {
        let result = [];
        let withPrefix = arrayType === Types$4.ArrayInterface ? true : false;
    ...
    const encodeJsonSlice = (tmpInstance) => {
        ...
        return Buffer$9.from(tmpInstance).toString('base64')
    };
    ...
    let { Buffer: Buffer$a } = safeBuffer;
    ...
    const decodeJsonField = (value, idx, type,instance) => {
        switch (type) {
            ...
            case Types$5.ByteSlice:
                {
                    return decodeJsonSlice(value)
                }
            case Types$5.ArrayInterface:
                {
                    return decodeJsonArray(value, instance, Types$5.ArrayInterface)
                }
            case Types$5.ArrayStruct:
                {
                    return decodeJsonArray(value, instance, Types$5.ArrayStruct)
                }
            case Types$5.Interface:
                {
    ...
    const decodeJsonSlice = (value) => {
        return Array.from(Buffer$a.from(value, 'base64'))
    };

    const decodeJsonInterface = (value, instance) => {
        let typeName = reflect.typeOf(instance);
        if (!undefined.lookup(typeName)) {
            throw new Error(`No ${typeName} was registered`)
        }
        let typeInfo = undefined.lookup(reflect.typeOf(instance));
    ...
    const decodeJsonArray = (value, instance, arrayType) => {
        let result = [];
        let withPrefix = arrayType === Types$5.ArrayInterface ? true : false;

        for (let i = 0; i < value.length; i++) {
            let type = Types$5.Struct;
            if (withPrefix) {
                type = Types$5.Interface;
            }
    ...
    const RegisteredType = registeredType.RegisteredType;
    ...
    class Codec {
        ...
        set(typeName, registeredType$$1) {
            privObj.typeMap.set(typeName, registeredType$$1);
        }
        ...
        marshalJson(obj) {
            if (!obj) return null;
            let typeInfo = this.lookup(reflect.typeOf(obj));
        ...
        unMarshalJson(json, instance) {
            ...
            let typeInfo = this.lookup(reflect.typeOf(instance));
            if (typeInfo && typeInfo.name) {
        ...
        unMarshalBinary(bz, instance, fieldOpts = new FieldOptions()) {
            ...
            if (!utils$1.isEqual(realbz.slice(0, 4), typeInfo.prefix)) {
                throw new TypeError("prefix not match")
            }
    ...
    let {Codec: Codec$1, FieldOptions: FieldOptions$1} = codec;


    let {Types: Types$7,WireType: WireType$4} = types;
    ...
    var src_1 = src.Codec;
    var src_3 = src.TypeFactory;
    var src_5 = src.Types;

    const StdTx = src_3.create('StdTx', [
        {
            name: 'msg',
            type: src_5.ArrayInterface,
        },
        {
            name: 'fee',
            type: src_5.Struct,
    ...
    const PubKeySecp256k1 = src_3.create('PubKeySecp256k1', [
        {
            name: 's',
            type: src_5.ByteSlice,
        },
    ], src_5.ByteSlice);
    const Signature$2 = src_3.create('signature', [
        {
            name: 'pub_key',
            type: src_5.Interface,
        },
        {
            name: 'signature',
            type: src_5.ByteSlice,
    ...
    const codec$1 = new src_1();
    codec$1.registerConcrete(new StdTx(), 'cosmos-sdk/StdTx', {});
    codec$1.registerConcrete(new PubKeySecp256k1(), 'tendermint/PubKeySecp256k1', {});
    const marshalBinary = tx => {
        return Buffer.from(codec$1.marshalBinary(tx)).toString('base64');
    };
    const marshalJson = tx => {
        return codec$1.marshalJson(tx);
    };
    const registerConcrete = (type, obj) => {
        codec$1.registerConcrete(new obj(), type, {});
    };
    ...
    function encodeSignMsg(stdMsg, chainId, seq, accountNumber, maxFeeInCoin) {
        ...
        const signMsgHash = sha_js('sha256').update(jsonStr).digest();
        return signMsgHash;
    }
    function encodeTx(msgs, rawPubKey, rawSigDER, maxFeeInCoin) {
        let sigs = new Array();
        for (let _i = 0; _i < rawPubKey.length; _i++) {
            const sig = new Signature$2(new PubKeySecp256k1(Buffer.from(rawPubKey[_i], 'hex').toJSON().data), Buffer.from(rawSigDER[_i], 'hex').toJSON().data);
            sigs.push(sig);
        }
    ...
    RIPEMD160$1.prototype._digest = function () {
      ...
      // produce result
      var buffer$$1 = Buffer$c.alloc ? Buffer$c.alloc(20) : new Buffer$c(20);
     ...
     */
    var src$3 = function numberToBN(arg) {
      if (typeof arg === 'string' || typeof arg === 'number') {
        var multiplier = new bn$1(1); // eslint-disable-line
        var formattedString = String(arg).toLowerCase().trim();
        var isHexPrefixed = formattedString.substr(0, 2) === '0x' || formattedString.substr(0, 3) === '-0x';
        var stringArg = src$2(formattedString); // eslint-disable-line
        if (stringArg.substr(0, 1) === '-') {
          stringArg = src$2(stringArg.slice(1));
    ...
    function getAddressFromPublicKey(pubKey) {
        ...
        const addr = new ripemd160$1().update(hashResult).digest();
    ...
    const ec$2 = new elliptic_2('secp256k1');
    class KeyPairSigner {
    ...
    const ec$3 = new elliptic_2('secp256k1');
    ...
    const Codec$2 = {
        'cosmos-sdk/MsgSend': src_3.create('MsgSend', [
            {
                name: 'from_address',
                type: src_5.String,
            },
    ...
    const Msgs = {
        makeTransferMsg(fromAddress, toAddress, amount) {
            const msg = new Codec$2[_types.TransferMsgType](fromAddress, toAddress, amount.map(am => new Coin(am.denom, am.amount)));
            return [msg];
        },
    };
    ...
    const Codec$3 = {
        'cosmos-sdk/MsgWithdrawDelegationReward': src_3.create('MsgWithdrawDelegationReward', [
            {
        ...
        'cosmos-sdk/MsgWithdrawValidatorCommission': src_3.create('MsgWithdrawValidatorCommission', [
            {
                name: 'validator_address',
                type: src_5.String,
            },
        ]),
        'cosmos-sdk/MsgModifyWithdrawAddress': src_3.create('MsgModifyWithdrawAddress', [
            {
                name: 'delegator_address',
                type: src_5.String,
            },
        ...
        'cosmos-sdk/MsgFundCommunityPool': src_3.create('MsgFundCommunityPool', [
            {
                name: 'amount',
                type: src_5.ArrayStruct,
            },
    ...
    const Msgs$1 = {
        makeWithdrawDelegationRewardMsg(delegator, validator) {
            const msg = new Codec$3[_types$1.WithdrawDelegationRewardMsgType](delegator, validator);
            return [msg];
        },
        makeWithdrawValidatorCommissionMsg(validator) {
            const msg = new Codec$3[_types$1.WithdrawValidatorCommissionMsgType](validator);
            return [msg];
        },
        makeModifyWithdrawAddressMsg(delegator, withdrawAddress) {
            const msg = new Codec$3[_types$1.ModifyWithdrawAddressMsgType](delegator, withdrawAddress);
            return [msg];
        },
        makeFundCommunityPool(amount, depositor) {
            const msg = new Codec$3[_types$1.FundCommunityPoolMsgType](amount.map(am => new Coin(am.denom, am.amount)), depositor);
            return [msg];
        },
    };
    class Distribution extends TransactionApi {
        ...
        fundCommunityPool(amount) {
            const msgs = Msgs$1.makeFundCommunityPool(amount, this.broadcast.signer.getAddress());
            return new Transaction(msgs, msgs => this.broadcast.sendTransaction(msgs));
        }
    }

    const Codec$4 = {
        'cosmos-sdk/MsgSubmitProposal': src_3.create('MsgSubmitProposal', [
            {
                name: 'content',
                type: src_5.Interface,
            },
        ...
        'cosmos-sdk/MsgDeposit': src_3.create('MsgDeposit', [
            {
                name: 'proposal_id',
                type: src_5.Int64,
            },
        ...
        'cosmos-sdk/MsgVote': src_3.create('MsgVote', [
            {
                name: 'proposal_id',
                type: src_5.Int64,
            },
        ...
        'cosmos-sdk/TextProposal': src_3.create('TextProposal', [
            {
                name: 'title',
                type: src_5.String,
            },
        ...
        'cosmos-sdk/ParameterChangeProposal': src_3.create('ParameterChangeProposal', [
            {
                name: 'title',
                type: src_5.String,
            },
        ...
        ParamChange: src_3.create('ParamChange', [
            {
                name: 'subspace',
                type: src_5.String,
            },
        ...
        'cosmos-sdk/CommunityPoolSpendProposal': src_3.create('CommunityPoolSpendProposal', [
            {
                name: 'title',
                type: src_5.String,
            },
        ...
        'cosmos-sdk/BurnedPoolSpendProposal': src_3.create('BurnedPoolSpendProposal', [
            {
                name: 'title',
                type: src_5.String,
            },
        ...
        'treasury/MintTreasurySupplyProposal': src_3.create('MintTreasurySupplyProposal', [
            {
                name: 'title',
                type: src_5.String,
            },
        ...
        'treasury/BurnTreasurySupplyProposal': src_3.create('BurnTreasurySupplyProposal', [
            {
                name: 'title',
                type: src_5.String,
            },
    ...
    const Msgs$2 = {
        makeSubmitProposalMsg(proposer, initialDeposit, content) {
            const msg = new Codec$4[_types$2.SubmitProposalMsgType](content, initialDeposit.map(am => new Coin(am.denom, am.amount)), proposer);
            return [msg];
        },
        makeVoteMsg(proposalId, voter, option) {
            ...
            const msg = new Codec$4[_types$2.VoteMsgType](proposalId, voter, numOption);
            return [msg];
        },
        makeDepositMsg(proposalId, depositor, amount) {
            const msg = new Codec$4[_types$2.DepositMsgType](proposalId, depositor, amount.map(am => new Coin(am.denom, am.amount)));
            return [msg];
        },
        makeTextProposal(proposer, initialDeposit, title, description) {
            const content = new Codec$4[_types$2.TextProposalMsgType](title, description);
        ...
        makeParameterChangeProposal(proposer, initialDeposit, title, description, changes) {
            const codecChanges = changes.map(change => new Codec$4['ParamChange'](change.subspace, change.key, change.value));
            const content = new Codec$4[_types$2.ParameterChangeProposalMsgType](title, description, codecChanges);
            return this.makeSubmitProposalMsg(proposer, initialDeposit, content);
        },
        makeCommunityPoolSpendProposal(proposer, initialDeposit, title, description, recipient, amount) {
            const content = new Codec$4[_types$2.CommunityPoolSpendProposalMsgType](title, description, recipient, amount.map(am => new Coin(am.denom, am.amount)));
            return this.makeSubmitProposalMsg(proposer, initialDeposit, content);
        },
        makeBurnedPoolSpendProposal(proposer, initialDeposit, title, description, recipient, amount) {
            const content = new Codec$4[_types$2.BurnedPoolSpendProposalMsgType](title, description, recipient, amount.map(am => new Coin(am.denom, am.amount)));
            return this.makeSubmitProposalMsg(proposer, initialDeposit, content);
        },
        makeMintTreasurySupplyProposal(proposer, initialDeposit, title, description, amount) {
            const content = new Codec$4[_types$2.MintTreasurySupplyProposalMsgType](title, description, amount.map(am => new Coin(am.denom, am.amount)));
            return this.makeSubmitProposalMsg(proposer, initialDeposit, content);
        },
        makeBurnTreasurySupplyProposal(proposer, initialDeposit, title, description, amount) {
            const content = new Codec$4[_types$2.BurnTreasurySupplyProposalMsgType](title, description, amount.map(am => new Coin(am.denom, am.amount)));
            return this.makeSubmitProposalMsg(proposer, initialDeposit, content);
        },
    };
    class Gov extends TransactionApi {
        ...
        submitMintTreasurySupplyProposal(initialDeposit, title, description, amount) {
            const msgs = Msgs$2.makeMintTreasurySupplyProposal(this.broadcast.signer.getAddress(), initialDeposit, title, description, amount);
            return new Transaction(msgs, msgs => this.broadcast.sendTransaction(msgs));
        }
        submitBurnTreasurySupplyProposal(initialDeposit, title, description, amount) {
            const msgs = Msgs$2.makeBurnTreasurySupplyProposal(this.broadcast.signer.getAddress(), initialDeposit, title, description, amount);
            return new Transaction(msgs, msgs => this.broadcast.sendTransaction(msgs));
        }
    }

    const Codec$5 = {
        'cosmos-sdk/MsgUnjail': src_3.create('MsgUnjail', [
            {
                name: 'address',
                type: src_5.String,
            },
    ...
    const Msgs$3 = {
        makeUnjailMsg(address) {
            const msg = new Codec$5[_types$3.UnjailMsgType](address);
            return [msg];
        },
    };
    ...
    const Codec$6 = {
        'cosmos-sdk/MsgCreateValidator': src_3.create('MsgCreateValidator', [
            {
                name: 'description',
                type: src_5.Struct,
            },
        ...
        Commission: src_3.create('Commission', [
            {
                name: 'rate',
                type: src_5.String,
            },
        ...
        Description: src_3.create('Description', [
            {
                name: 'moniker',
                type: src_5.String,
            },
        ...
        'cosmos-sdk/MsgEditValidator': src_3.create('MsgEditValidator', [
            {
                name: 'description',
                type: src_5.Struct,
            },
        ...
        'cosmos-sdk/MsgDelegate': src_3.create('MsgDelegate', [
            {
                name: 'delegator_address',
                type: src_5.String,
            },
        ...
        'cosmos-sdk/MsgUndelegate': src_3.create('MsgUndelegate', [
            {
                name: 'delegator_address',
                type: src_5.String,
            },
        ...
        'cosmos-sdk/MsgBeginRedelegate': src_3.create('MsgBeginRedelegate', [
            {
                name: 'delegator_address',
                type: src_5.String,
            },
    ...
    const Msgs$4 = {
        makeDelegateMsg(delegator, validator, amount) {
            const msg = new Codec$6[_types$4.DelegateMsgType](delegator, validator, new Coin(amount.denom, amount.amount));
            return [msg];
        },
        makeUndelegateMsg(delegator, validator, amount) {
            const msg = new Codec$6[_types$4.UndelegateMsgType](delegator, validator, new Coin(amount.denom, amount.amount));
            return [msg];
        },
        makeBeginRedelegateMsg(delegator, srcValidator, dstValidator, amount) {
            const msg = new Codec$6[_types$4.BeginRedelegateMsgType](delegator, srcValidator, dstValidator, new Coin(amount.denom, amount.amount));
            return [msg];
        },
        makeCreateValidatorMsg(description, commission, minSelfDelegation, delegator, validator, pubkey, value) {
            let desc = new Codec$6[_types$4.Description](description.moniker, description.identity, description.website, description.securityContact, description.details);
            let comm = new Codec$6[_types$4.Commission](commission.rate, commission.maxRate, commission.maxChangeRate);
            const msg = new Codec$6[_types$4.CreateValidatorMsgType](desc, comm, minSelfDelegation, delegator, validator, pubkey, new Coin(value.denom, value.amount));
            return [msg];
        },
        makeEditValidatorMsg(description, address, commissionRate, minSelfDelegation) {
            let desc = new Codec$6[_types$4.Description](description.moniker, description.identity, description.website, description.securityContact, description.details);
            const msg = new Codec$6[_types$4.EditValidatorMsgType](desc, address, commissionRate, minSelfDelegation);
            return [msg];
        },
    };
    ...
    const Codec$7 = {
        'treasury/AddOperator': src_3.create('AddOperator', [
            {
                name: 'sender',
                type: src_5.String,
            },
        ...
        'treasury/RemoveOperator': src_3.create('RemoveOperator', [
            {
                name: 'sender',
                type: src_5.String,
            },
        ...
        'treasury/Disburse': src_3.create('Disburse', [
            {
                name: 'operator',
                type: src_5.String,
            },
        ...
        'treasury/ApproveDisbursement': src_3.create('ApproveDisbursement', [
            {
                name: 'manager',
                type: src_5.String,
            },
        ...
        'treasury/CancelDisbursement': src_3.create('CancelDisbursement', [
            {
                name: 'manager',
                type: src_5.String,
            },
        ...
        'treasury/Burn': src_3.create('Burn', [
            {
                name: 'operator',
                type: src_5.String,
            },
        ...
        'treasury/ApproveBurn': src_3.create('ApproveBurn', [
            {
                name: 'manager',
                type: src_5.String,
            },
        ...
        'treasury/CancelBurn': src_3.create('CancelBurn', [
            {
                name: 'manager',
                type: src_5.String,
            },
    ...
    const Msgs$5 = {
        makeAddOperatorMsg(sender, operator) {
            const msg = new Codec$7[_types$5.AddOperatorMsgType](sender, operator);
            return [msg];
        },
        makeRemoveOperatorMsg(sender, operator) {
            const msg = new Codec$7[_types$5.RemoveOperatorMsgType](sender, operator);
            return [msg];
        },
        makeDisburseMsg(operator, recipient, amount, reference) {
            const msg = new Codec$7[_types$5.DisburseMsgType](operator, recipient, amount.map(am => new Coin(am.denom, am.amount)), reference);
            return [msg];
        },
        makeApproveDisbursementMsg(mananger, recipient, scheduled_for) {
            const msg = new Codec$7[_types$5.ApproveDisbursementMsgType](mananger, recipient, scheduled_for);
            return [msg];
        },
        makeCancelDisbursementMsg(mananger, recipient, scheduled_for) {
            const msg = new Codec$7[_types$5.CancelDisbursementMsgType](mananger, recipient, scheduled_for);
            return [msg];
        },
        makeBurnMsg(operator, amount) {
            const msg = new Codec$7[_types$5.BurnMsgType](operator, amount.map(am => new Coin(am.denom, am.amount)));
            return [msg];
        },
        makeApproveBurnMsg(mananger, scheduled_for) {
            const msg = new Codec$7[_types$5.ApproveBurnMsgType](mananger, scheduled_for);
            return [msg];
        },
        makeCancelBurnMsg(mananger, scheduled_for) {
            const msg = new Codec$7[_types$5.CancelBurnMsgType](mananger, scheduled_for);
            return [msg];
        },
    };
    class Treasury extends TransactionApi {
        addOperator(operator) {
            const msgs = Msgs$5.makeAddOperatorMsg(this.broadcast.signer.getAddress(), operator);
            return new Transaction(msgs, msgs => this.broadcast.sendTransaction(msgs));
        }
        removeOperator(operator) {
            const msgs = Msgs$5.makeRemoveOperatorMsg(this.broadcast.signer.getAddress(), operator);
            return new Transaction(msgs, msgs => this.broadcast.sendTransaction(msgs));
        }
        disburse(recipient, amount, reference) {
            const msgs = Msgs$5.makeDisburseMsg(this.broadcast.signer.getAddress(), recipient, amount, reference);
            return new Transaction(msgs, msgs => this.broadcast.sendTransaction(msgs));
        }
        approveDisbursement(recipient, scheduled_for) {
            const msgs = Msgs$5.makeApproveDisbursementMsg(this.broadcast.signer.getAddress(), recipient, scheduled_for);
            return new Transaction(msgs, msgs => this.broadcast.sendTransaction(msgs));
        }
        cancelDisbursement(recipient, scheduled_for) {
            const msgs = Msgs$5.makeCancelDisbursementMsg(this.broadcast.signer.getAddress(), recipient, scheduled_for);
            return new Transaction(msgs, msgs => this.broadcast.sendTransaction(msgs));
        }
        burn(amount) {
            const msgs = Msgs$5.makeBurnMsg(this.broadcast.signer.getAddress(), amount);
            return new Transaction(msgs, msgs => this.broadcast.sendTransaction(msgs));
        }
        approveBurn(scheduled_for) {
            const msgs = Msgs$5.makeApproveBurnMsg(this.broadcast.signer.getAddress(), scheduled_for);
            return new Transaction(msgs, msgs => this.broadcast.sendTransaction(msgs));
        }
        cancelBurn(scheduled_for) {
            const msgs = Msgs$5.makeCancelBurnMsg(this.broadcast.signer.getAddress(), scheduled_for);
            return new Transaction(msgs, msgs => this.broadcast.sendTransaction(msgs));
        }
    }

    const Codec$8 = {
        'cosmos-sdk/MsgSubmitExecution': src_3.create('MsgSubmitExecution', [
            {
                name: 'content',
                type: src_5.Interface,
            },
    ...
    Object.keys(Codec$8).forEach(codec => registerConcrete(codec, Codec$8[codec]));
    ...
    const Msgs$6 = {
        makeSubmitExecutionMsg(executor, content) {
            const msg = new Codec$8[_types$6.SubmitExecutionMsgType](content, executor);
            return [msg];
        },
        makeTextProposal(proposer, title, description) {
            const content = new Codec$4[_types$6.TextProposalMsgType](title, description);
            return this.makeSubmitExecutionMsg(proposer, content);
        },
        makeParameterChangeProposal(proposer, title, description, changes) {
            const codecChanges = changes.map(change => new Codec$4['ParamChange'](change.subspace, change.key, change.value));
            const content = new Codec$4[_types$6.ParameterChangeProposalMsgType](title, description, codecChanges);
            return this.makeSubmitExecutionMsg(proposer, content);
        },
        makeCommunityPoolSpendProposal(proposer, title, description, recipient, amount) {
            const content = new Codec$4[_types$6.CommunityPoolSpendProposalMsgType](title, description, recipient, amount.map(am => new Coin(am.denom, am.amount)));
            return this.makeSubmitExecutionMsg(proposer, content);
        },
        makeBurnedPoolSpendProposal(proposer, title, description, recipient, amount) {
            const content = new Codec$4[_types$6.BurnedPoolSpendProposalMsgType](title, description, recipient, amount.map(am => new Coin(am.denom, am.amount)));
            return this.makeSubmitExecutionMsg(proposer, content);
        },
        makeMintTreasurySupplyProposal(proposer, title, description, amount) {
            const content = new Codec$4[_types$6.MintTreasurySupplyProposalMsgType](title, description, amount.map(am => new Coin(am.denom, am.amount)));
            return this.makeSubmitExecutionMsg(proposer, content);
        },
        makeBurnTreasurySupplyProposal(proposer, title, description, amount) {
            const content = new Codec$4[_types$6.BurnTreasurySupplyProposalMsgType](title, description, amount.map(am => new Coin(am.denom, am.amount)));
            return this.makeSubmitExecutionMsg(proposer, content);
        },
    };
    class Control extends TransactionApi {
        submitTextProposal(title, description) {
            const msgs = Msgs$6.makeTextProposal(this.broadcast.signer.getAddress(), title, description);
            return new Transaction(msgs, msgs => this.broadcast.sendTransaction(msgs));
        }
        submitParameterChangeProposal(title, description, changes) {
            const msgs = Msgs$6.makeParameterChangeProposal(this.broadcast.signer.getAddress(), title, description, changes);
            return new Transaction(msgs, msgs => this.broadcast.sendTransaction(msgs));
        }
        submitCommunityPoolSpendProposal(title, description, recipient, amount) {
            const msgs = Msgs$6.makeCommunityPoolSpendProposal(this.broadcast.signer.getAddress(), title, description, recipient, amount);
            return new Transaction(msgs, msgs => this.broadcast.sendTransaction(msgs));
        }
        submitBurnedPoolSpendProposal(title, description, recipient, amount) {
            const msgs = Msgs$6.makeBurnedPoolSpendProposal(this.broadcast.signer.getAddress(), title, description, recipient, amount);
            return new Transaction(msgs, msgs => this.broadcast.sendTransaction(msgs));
        }
        submitMintTreasurySupplyProposal(title, description, amount) {
            const msgs = Msgs$6.makeMintTreasurySupplyProposal(this.broadcast.signer.getAddress(), title, description, amount);
            return new Transaction(msgs, msgs => this.broadcast.sendTransaction(msgs));
        }
        submitBurnTreasurySupplyProposal(title, description, amount) {
            const msgs = Msgs$6.makeBurnTreasurySupplyProposal(this.broadcast.signer.getAddress(), title, description, amount);
            return new Transaction(msgs, msgs => this.broadcast.sendTransaction(msgs));
        }
    }
