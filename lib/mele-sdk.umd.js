(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('bip32'), require('bip39')) :
    typeof define === 'function' && define.amd ? define(['exports', 'bip32', 'bip39'], factory) :
    (factory((global.mele = {}),global.bip32,global.bip39));
}(this, (function (exports,bip32,bip39) { 'use strict';
    ...
    class GovQuery {
        ...
        getParameters() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const ParamDepositPath = Keys$3.Query.ParamDepositPath;
                const ParamVotingPath = Keys$3.Query.ParamVotingPath;
                const ParamTallyingPath = Keys$3.Query.ParamTallyingPath;
        ...
        getProposals(voter = '', depositor = '', status = '', page = 1, limit = 100) {
            const QueryPath = Keys$3.Query.QueryPath;
            const ProposalsPath = Keys$3.Query.ProposalsPath;
            let pStatus = 0;
        ...
        getProposal(id) {
            const QueryPath = Keys$3.Query.QueryPath;
            const ProposalPath = Keys$3.Query.ProposalPath;
            return this._transport.query([], JSON.stringify({
                ProposalID: id
        ...
        getDeposits(id) {
            const QueryPath = Keys$3.Query.QueryPath;
            const DepositsPath = Keys$3.Query.DepositsPath;
            return this._transport.query([], JSON.stringify({
                ProposalID: id
        ...
        getDeposit(id, depositor) {
            const QueryPath = Keys$3.Query.QueryPath;
            const DepositPath = Keys$3.Query.DepositPath;
            return this._transport.query([], JSON.stringify({
                ProposalID: id,
                Depositor: depositor
        ...
        getVotes(id, page = 1, limit = 100) {
            const QueryPath = Keys$3.Query.QueryPath;
            const VotesPath = Keys$3.Query.VotesPath;
            return this._transport.query([], JSON.stringify({
                ProposalID: id,
                Page: String(page),
                Limit: String(limit)
        ...
        getVote(id, voter) {
            const QueryPath = Keys$3.Query.QueryPath;
            const VotePath = Keys$3.Query.VotePath;
            return this._transport.query([], JSON.stringify({
                ProposalID: id,
                Voter: voter
            }), QueryPath, VotePath);
        ...
        getTally(id) {
            const QueryPath = Keys$3.Query.QueryPath;
            const TallyPath = Keys$3.Query.TallyPath;
            return this._transport.query([], JSON.stringify({
                ProposalID: id
            }), QueryPath, TallyPath);
        }
    ...
    */
    ...
    var decoder_6 = decoder.decodeFieldNumberAndType;
    var decoder_7 = decoder.decodeSlice;
    ...
    let {Codec: Codec$1, FieldOtions: FieldOtions$1} = codec;
    ...
    var Buffer$b = require('buffer').Buffer;
    ...
    var Buffer$c = require('buffer').Buffer;
    ...
    RIPEMD160$1.prototype._digest = function () {
      ...
      // produce result
      var buffer$$1 = Buffer$e.alloc ? Buffer$e.alloc(20) : new Buffer$e(20);
    ...
    const Msgs$2 = {
        ...
        makeVoteMsg(proposalId, voter, option) {
            ...
            const msg = new Codec$4[_types$2.VoteMsgType](proposalId, voter, voteOption);
            return [msg];
        },
