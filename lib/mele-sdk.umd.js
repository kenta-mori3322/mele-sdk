(function (global, factory) {
	...
	*/
	...
	RIPEMD160$1.prototype._digest = function () {
	  ...
	  // produce result
	  var buffer$$1 = Buffer$5.alloc ? Buffer$5.alloc(20) : new Buffer$5(20);
	...
	let { Buffer: Buffer$d } = safeBuffer;
	...
	const encodeJsonSlice = (tmpInstance) => {
	    ...
	    return Buffer$d.from(tmpInstance).toString('base64')
	};
	...
	let { Buffer: Buffer$e } = safeBuffer;
	...
	const decodeJsonSlice = (value) => {
	    return Array.from(Buffer$e.from(value, 'base64'))
	};
	...
	Object.keys(Msgs).forEach(msg => {
	    codec$1.registerConcrete(new Msgs[msg](), msg, {});
	});
	...
	***************************************************************************** */
	...
	function safeBroadcast(signers, query, transport, options, makeTxFunc) {
	...
	class Mele {
	    ...
	    sendTransaction(msgs) {
	        return safeBroadcast([this._signer.getAddress()], this._query, this._transport, this._options, accSignInfos => {
