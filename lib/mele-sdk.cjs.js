...
const Codec$1 = {
    ...
    'treasury/MintTreasurySupplyProposal': jsAmino.TypeFactory.create('MintTreasurySupplyProposal', [
        {
            name: 'title',
            type: jsAmino.Types.String,
        },
    ...
    'treasury/BurnTreasurySupplyProposal': jsAmino.TypeFactory.create('BurnTreasurySupplyProposal', [
        {
            name: 'title',
            type: jsAmino.Types.String,
        },
    ...
    'cosmos-sdk/SoftwareUpgradeProposal': jsAmino.TypeFactory.create('SoftwareUpgradeProposal', [
        {
            name: 'title',
            type: jsAmino.Types.String,
        },
    ...
    UpgradePlan: jsAmino.TypeFactory.create('UpgradePlan', [
        {
            name: 'name',
            type: jsAmino.Types.String,
        },
    ...
    'cosmos-sdk/CancelSoftwareUpgradeProposal': jsAmino.TypeFactory.create('CancelSoftwareUpgradeProposal', [
        {
            name: 'title',
            type: jsAmino.Types.String,
        },
...
const Codec$2 = {
    'cosmos-sdk/MsgSubmitExecution': jsAmino.TypeFactory.create('MsgSubmitExecution', [
        {
            name: 'content',
            type: jsAmino.Types.Interface,
        },
...
const Msgs$1 = {
    makeSubmitExecutionMsg(executor, content) {
        const msg = new Codec$2[_types$1.SubmitExecutionMsgType](content, executor);
        return [msg];
    },
    makeTextProposal(proposer, title, description) {
        const content = new Codec$1[_types$1.TextProposalMsgType](title, description);
        return this.makeSubmitExecutionMsg(proposer, content);
    },
    makeParameterChangeProposal(proposer, title, description, changes) {
        const codecChanges = changes.map(change => new Codec$1['ParamChange'](change.subspace, change.key, change.value));
        const content = new Codec$1[_types$1.ParameterChangeProposalMsgType](title, description, codecChanges);
        return this.makeSubmitExecutionMsg(proposer, content);
    },
    makeCommunityPoolSpendProposal(proposer, title, description, recipient, amount) {
        const content = new Codec$1[_types$1.CommunityPoolSpendProposalMsgType](title, description, recipient, amount.map(am => new Coin(am.denom, am.amount)));
        return this.makeSubmitExecutionMsg(proposer, content);
    },
    makeBurnedPoolSpendProposal(proposer, title, description, recipient, amount) {
        const content = new Codec$1[_types$1.BurnedPoolSpendProposalMsgType](title, description, recipient, amount.map(am => new Coin(am.denom, am.amount)));
        return this.makeSubmitExecutionMsg(proposer, content);
    },
    makeMintTreasurySupplyProposal(proposer, title, description, amount) {
        const content = new Codec$1[_types$1.MintTreasurySupplyProposalMsgType](title, description, amount.map(am => new Coin(am.denom, am.amount)));
        return this.makeSubmitExecutionMsg(proposer, content);
    },
    makeBurnTreasurySupplyProposal(proposer, title, description, amount) {
        const content = new Codec$1[_types$1.BurnTreasurySupplyProposalMsgType](title, description, amount.map(am => new Coin(am.denom, am.amount)));
        return this.makeSubmitExecutionMsg(proposer, content);
    },
    makeSoftwareUpgradeProposal(proposer, title, description, plan) {
        const cPlan = new Codec$1['UpgradePlan'](plan.name, plan.height, plan.info);
        const content = new Codec$1[_types$1.SoftwareUpgradeProposalMsgType](title, description, cPlan);
        return this.makeSubmitExecutionMsg(proposer, content);
    },
    makeCancelSoftwareUpgradeProposal(proposer, title, description) {
        const content = new Codec$1[_types$1.CancelSoftwareUpgradeProposalMsgType](title, description);
        return this.makeSubmitExecutionMsg(proposer, content);
    },
};
...
const Codec$3 = {
    ...
    'cosmos-sdk/MsgFundCommunityPool': jsAmino.TypeFactory.create('MsgFundCommunityPool', [
        {
            name: 'amount',
            type: jsAmino.Types.ArrayStruct,
        },
...
const Msgs$2 = {
    makeWithdrawDelegationRewardMsg(delegator, validator) {
        const msg = new Codec$3[_types$2.WithdrawDelegationRewardMsgType](delegator, validator);
        return [msg];
    },
    makeWithdrawValidatorCommissionMsg(validator) {
        const msg = new Codec$3[_types$2.WithdrawValidatorCommissionMsgType](validator);
        return [msg];
    },
    makeModifyWithdrawAddressMsg(delegator, withdrawAddress) {
        const msg = new Codec$3[_types$2.ModifyWithdrawAddressMsgType](delegator, withdrawAddress);
        return [msg];
    },
    makeFundCommunityPool(amount, depositor) {
        const msg = new Codec$3[_types$2.FundCommunityPoolMsgType](amount.map(am => new Coin(am.denom, am.amount)), depositor);
        return [msg];
    },
};
...
const Msgs$3 = {
    makeSubmitProposalMsg(proposer, initialDeposit, content) {
        const msg = new Codec$1[_types$3.SubmitProposalMsgType](content, initialDeposit.map(am => new Coin(am.denom, am.amount)), proposer);
        return [msg];
    },
    makeVoteMsg(proposalId, voter, option) {
        ...
        const msg = new Codec$1[_types$3.VoteMsgType](proposalId, voter, numOption);
        return [msg];
    },
    makeDepositMsg(proposalId, depositor, amount) {
        const msg = new Codec$1[_types$3.DepositMsgType](proposalId, depositor, amount.map(am => new Coin(am.denom, am.amount)));
        return [msg];
    },
    makeTextProposal(proposer, initialDeposit, title, description) {
        const content = new Codec$1[_types$3.TextProposalMsgType](title, description);
    ...
    makeParameterChangeProposal(proposer, initialDeposit, title, description, changes) {
        const codecChanges = changes.map(change => new Codec$1['ParamChange'](change.subspace, change.key, change.value));
        const content = new Codec$1[_types$3.ParameterChangeProposalMsgType](title, description, codecChanges);
        return this.makeSubmitProposalMsg(proposer, initialDeposit, content);
    },
    makeCommunityPoolSpendProposal(proposer, initialDeposit, title, description, recipient, amount) {
        const content = new Codec$1[_types$3.CommunityPoolSpendProposalMsgType](title, description, recipient, amount.map(am => new Coin(am.denom, am.amount)));
        return this.makeSubmitProposalMsg(proposer, initialDeposit, content);
    },
    makeBurnedPoolSpendProposal(proposer, initialDeposit, title, description, recipient, amount) {
        const content = new Codec$1[_types$3.BurnedPoolSpendProposalMsgType](title, description, recipient, amount.map(am => new Coin(am.denom, am.amount)));
        return this.makeSubmitProposalMsg(proposer, initialDeposit, content);
    },
    makeMintTreasurySupplyProposal(proposer, initialDeposit, title, description, amount) {
        const content = new Codec$1[_types$3.MintTreasurySupplyProposalMsgType](title, description, amount.map(am => new Coin(am.denom, am.amount)));
        return this.makeSubmitProposalMsg(proposer, initialDeposit, content);
    },
    makeBurnTreasurySupplyProposal(proposer, initialDeposit, title, description, amount) {
        const content = new Codec$1[_types$3.BurnTreasurySupplyProposalMsgType](title, description, amount.map(am => new Coin(am.denom, am.amount)));
        return this.makeSubmitProposalMsg(proposer, initialDeposit, content);
    },
    makeSoftwareUpgradeProposal(proposer, initialDeposit, title, description, plan) {
        const cPlan = new Codec$1['UpgradePlan'](plan.name, plan.height, plan.info);
        const content = new Codec$1[_types$3.SoftwareUpgradeProposalMsgType](title, description, cPlan);
        return this.makeSubmitProposalMsg(proposer, initialDeposit, content);
    },
    makeCancelSoftwareUpgradeProposal(proposer, initialDeposit, title, description) {
        const content = new Codec$1[_types$3.CancelSoftwareUpgradeProposalMsgType](title, description);
        return this.makeSubmitProposalMsg(proposer, initialDeposit, content);
    },
};
...
const Msgs$4 = {
    makeUnjailMsg(address) {
        const msg = new Codec$4[_types$4.UnjailMsgType](address);
        return [msg];
    },
};
...
const Msgs$5 = {
    makeDelegateMsg(delegator, validator, amount) {
        const msg = new Codec$5[_types$5.DelegateMsgType](delegator, validator, new Coin(amount.denom, amount.amount));
        return [msg];
    },
    makeUndelegateMsg(delegator, validator, amount) {
        const msg = new Codec$5[_types$5.UndelegateMsgType](delegator, validator, new Coin(amount.denom, amount.amount));
        return [msg];
    },
    makeBeginRedelegateMsg(delegator, srcValidator, dstValidator, amount) {
        const msg = new Codec$5[_types$5.BeginRedelegateMsgType](delegator, srcValidator, dstValidator, new Coin(amount.denom, amount.amount));
        return [msg];
    },
    makeCreateValidatorMsg(description, commission, minSelfDelegation, delegator, validator, pubkey, value) {
        let desc = new Codec$5[_types$5.Description](description.moniker, description.identity, description.website, description.securityContact, description.details);
        let comm = new Codec$5[_types$5.Commission](commission.rate, commission.maxRate, commission.maxChangeRate);
        const msg = new Codec$5[_types$5.CreateValidatorMsgType](desc, comm, minSelfDelegation, delegator, validator, pubkey, new Coin(value.denom, value.amount));
        return [msg];
    },
    makeEditValidatorMsg(description, address, commissionRate, minSelfDelegation) {
        let desc = new Codec$5[_types$5.Description](description.moniker, description.identity, description.website, description.securityContact, description.details);
        const msg = new Codec$5[_types$5.EditValidatorMsgType](desc, address, commissionRate, minSelfDelegation);
        return [msg];
    },
};
...
const Codec$6 = {
    'treasury/AddOperator': jsAmino.TypeFactory.create('AddOperator', [
        {
            name: 'sender',
            type: jsAmino.Types.String,
        },
    ...
    'treasury/RemoveOperator': jsAmino.TypeFactory.create('RemoveOperator', [
        {
            name: 'sender',
            type: jsAmino.Types.String,
        },
    ...
    'treasury/Disburse': jsAmino.TypeFactory.create('Disburse', [
        {
            name: 'operator',
            type: jsAmino.Types.String,
        },
    ...
    'treasury/ApproveDisbursement': jsAmino.TypeFactory.create('ApproveDisbursement', [
        {
            name: 'manager',
            type: jsAmino.Types.String,
        },
    ...
    'treasury/CancelDisbursement': jsAmino.TypeFactory.create('CancelDisbursement', [
        {
            name: 'manager',
            type: jsAmino.Types.String,
        },
    ...
    'treasury/Burn': jsAmino.TypeFactory.create('Burn', [
        {
            name: 'operator',
            type: jsAmino.Types.String,
        },
    ...
    'treasury/ApproveBurn': jsAmino.TypeFactory.create('ApproveBurn', [
        {
            name: 'manager',
            type: jsAmino.Types.String,
        },
    ...
    'treasury/CancelBurn': jsAmino.TypeFactory.create('CancelBurn', [
        {
            name: 'manager',
            type: jsAmino.Types.String,
        },
...
const Msgs$6 = {
    makeAddOperatorMsg(sender, operator) {
        const msg = new Codec$6[_types$6.AddOperatorMsgType](sender, operator);
        return [msg];
    },
    makeRemoveOperatorMsg(sender, operator) {
        const msg = new Codec$6[_types$6.RemoveOperatorMsgType](sender, operator);
        return [msg];
    },
    makeDisburseMsg(operator, recipient, amount, reference) {
        const msg = new Codec$6[_types$6.DisburseMsgType](operator, recipient, amount.map(am => new Coin(am.denom, am.amount)), reference);
        return [msg];
    },
    makeApproveDisbursementMsg(mananger, recipient, scheduled_for) {
        const msg = new Codec$6[_types$6.ApproveDisbursementMsgType](mananger, recipient, scheduled_for);
        return [msg];
    },
    makeCancelDisbursementMsg(mananger, recipient, scheduled_for) {
        const msg = new Codec$6[_types$6.CancelDisbursementMsgType](mananger, recipient, scheduled_for);
        return [msg];
    },
    makeBurnMsg(operator, amount) {
        const msg = new Codec$6[_types$6.BurnMsgType](operator, amount.map(am => new Coin(am.denom, am.amount)));
        return [msg];
    },
    makeApproveBurnMsg(mananger, scheduled_for) {
        const msg = new Codec$6[_types$6.ApproveBurnMsgType](mananger, scheduled_for);
        return [msg];
    },
    makeCancelBurnMsg(mananger, scheduled_for) {
        const msg = new Codec$6[_types$6.CancelBurnMsgType](mananger, scheduled_for);
        return [msg];
    },
};
