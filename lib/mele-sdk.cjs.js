...
const Msgs$1 = {
    ...
    makeFundCommunityPool(amount, depositor) {
        const msg = new Codec$1[_types$1.FundCommunityPoolMsgType](amount.map(am => new Coin(am.denom, am.amount)), depositor);
        return [msg];
    },
};
...
const Msgs$2 = {
    ...
    makeMintTreasurySupplyProposal(proposer, initialDeposit, title, description, amount) {
        const content = new Codec$2[_types$2.MintTreasurySupplyProposalMsgType](title, description, amount.map(am => new Coin(am.denom, am.amount)));
        return this.makeSubmitProposalMsg(proposer, initialDeposit, content);
    },
    makeBurnTreasurySupplyProposal(proposer, initialDeposit, title, description, amount) {
        const content = new Codec$2[_types$2.BurnTreasurySupplyProposalMsgType](title, description, amount.map(am => new Coin(am.denom, am.amount)));
        return this.makeSubmitProposalMsg(proposer, initialDeposit, content);
    },
};
...
const Msgs$5 = {
    makeAddOperatorMsg(sender, operator) {
        const msg = new Codec$5[_types$5.AddOperatorMsgType](sender, operator);
        return [msg];
    },
    makeRemoveOperatorMsg(sender, operator) {
        const msg = new Codec$5[_types$5.RemoveOperatorMsgType](sender, operator);
        return [msg];
    },
    makeDisburseMsg(operator, recipient, amount, reference) {
        const msg = new Codec$5[_types$5.DisburseMsgType](operator, recipient, amount.map(am => new Coin(am.denom, am.amount)), reference);
        return [msg];
    },
    makeApproveDisbursementMsg(mananger, recipient, scheduled_for) {
        const msg = new Codec$5[_types$5.ApproveDisbursementMsgType](mananger, recipient, scheduled_for);
        return [msg];
    },
    makeCancelDisbursementMsg(mananger, recipient, scheduled_for) {
        const msg = new Codec$5[_types$5.CancelDisbursementMsgType](mananger, recipient, scheduled_for);
        return [msg];
    },
    makeBurnMsg(operator, amount) {
        const msg = new Codec$5[_types$5.BurnMsgType](operator, amount.map(am => new Coin(am.denom, am.amount)));
        return [msg];
    },
    makeApproveBurnMsg(mananger, scheduled_for) {
        const msg = new Codec$5[_types$5.ApproveBurnMsgType](mananger, scheduled_for);
        return [msg];
    },
    makeCancelBurnMsg(mananger, scheduled_for) {
        const msg = new Codec$5[_types$5.CancelBurnMsgType](mananger, scheduled_for);
        return [msg];
    },
};
...
const Msgs$6 = {
    makeSubmitExecutionMsg(executor, content) {
        const msg = new Codec$6[_types$6.SubmitExecutionMsgType](content, executor);
        return [msg];
    },
    makeTextProposal(proposer, title, description) {
        const content = new Codec$2[_types$6.TextProposalMsgType](title, description);
        return this.makeSubmitExecutionMsg(proposer, content);
    },
    makeParameterChangeProposal(proposer, title, description, changes) {
        const codecChanges = changes.map(change => new Codec$2['ParamChange'](change.subspace, change.key, change.value));
        const content = new Codec$2[_types$6.ParameterChangeProposalMsgType](title, description, codecChanges);
        return this.makeSubmitExecutionMsg(proposer, content);
    },
    makeCommunityPoolSpendProposal(proposer, title, description, recipient, amount) {
        const content = new Codec$2[_types$6.CommunityPoolSpendProposalMsgType](title, description, recipient, amount.map(am => new Coin(am.denom, am.amount)));
        return this.makeSubmitExecutionMsg(proposer, content);
    },
    makeBurnedPoolSpendProposal(proposer, title, description, recipient, amount) {
        const content = new Codec$2[_types$6.BurnedPoolSpendProposalMsgType](title, description, recipient, amount.map(am => new Coin(am.denom, am.amount)));
        return this.makeSubmitExecutionMsg(proposer, content);
    },
    makeMintTreasurySupplyProposal(proposer, title, description, amount) {
        const content = new Codec$2[_types$6.MintTreasurySupplyProposalMsgType](title, description, amount.map(am => new Coin(am.denom, am.amount)));
        return this.makeSubmitExecutionMsg(proposer, content);
    },
    makeBurnTreasurySupplyProposal(proposer, title, description, amount) {
        const content = new Codec$2[_types$6.BurnTreasurySupplyProposalMsgType](title, description, amount.map(am => new Coin(am.denom, am.amount)));
        return this.makeSubmitExecutionMsg(proposer, content);
    },
};
