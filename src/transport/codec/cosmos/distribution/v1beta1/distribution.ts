...
export interface BurnedPoolSpendProposal {
    title: string
    description: string
    recipient: string
    amount: Coin[]
...
export interface BurnedPoolSpendProposalWithDeposit {
    title: string
    description: string
    recipient: string
    amount: string
...
const baseBurnedPoolSpendProposal: object = {
    title: '',
    description: '',
    recipient: '',
}

export const BurnedPoolSpendProposal = {
    encode(message: BurnedPoolSpendProposal, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
        if (message.title !== '') {
            writer.uint32(10).string(message.title)
        }
        if (message.description !== '') {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): BurnedPoolSpendProposal {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input)
        let end = length === undefined ? reader.len : reader.pos + length
        const message = {
            ...baseBurnedPoolSpendProposal,
        } as BurnedPoolSpendProposal
        message.amount = []
        while (reader.pos < end) {
            const tag = reader.uint32()
            switch (tag >>> 3) {
    ...
    fromJSON(object: any): BurnedPoolSpendProposal {
        const message = {
            ...baseBurnedPoolSpendProposal,
        } as BurnedPoolSpendProposal
        message.amount = []
    ...
    toJSON(message: BurnedPoolSpendProposal): unknown {
        const obj: any = {}
        message.title !== undefined && (obj.title = message.title)
        message.description !== undefined && (obj.description = message.description)
        message.recipient !== undefined && (obj.recipient = message.recipient)
    ...
    fromPartial(object: DeepPartial<BurnedPoolSpendProposal>): BurnedPoolSpendProposal {
        const message = {
            ...baseBurnedPoolSpendProposal,
        } as BurnedPoolSpendProposal
        message.amount = []
...
const baseBurnedPoolSpendProposalWithDeposit: object = {
    title: '',
    description: '',
    recipient: '',
    amount: '',
...
export const BurnedPoolSpendProposalWithDeposit = {
    encode(
        message: BurnedPoolSpendProposalWithDeposit,
        writer: _m0.Writer = _m0.Writer.create()
    ): _m0.Writer {
        if (message.title !== '') {
            writer.uint32(10).string(message.title)
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): BurnedPoolSpendProposalWithDeposit {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input)
        let end = length === undefined ? reader.len : reader.pos + length
        const message = {
            ...baseBurnedPoolSpendProposalWithDeposit,
        } as BurnedPoolSpendProposalWithDeposit
        while (reader.pos < end) {
            const tag = reader.uint32()
            switch (tag >>> 3) {
                case 1:
    ...
    fromJSON(object: any): BurnedPoolSpendProposalWithDeposit {
        const message = {
            ...baseBurnedPoolSpendProposalWithDeposit,
        } as BurnedPoolSpendProposalWithDeposit
        if (object.title !== undefined && object.title !== null) {
    ...
    toJSON(message: BurnedPoolSpendProposalWithDeposit): unknown {
        const obj: any = {}
        message.title !== undefined && (obj.title = message.title)
        message.description !== undefined && (obj.description = message.description)
        message.recipient !== undefined && (obj.recipient = message.recipient)
    ...
    fromPartial(
        object: DeepPartial<BurnedPoolSpendProposalWithDeposit>
    ): BurnedPoolSpendProposalWithDeposit {
        const message = {
            ...baseBurnedPoolSpendProposalWithDeposit,
        } as BurnedPoolSpendProposalWithDeposit
        if (object.title !== undefined && object.title !== null) {
