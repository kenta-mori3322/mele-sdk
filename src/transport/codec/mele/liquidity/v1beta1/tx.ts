...
export class MsgClientImpl implements Msg {
    ...
    CreatePool(request: MsgCreatePool): Promise<MsgCreatePoolResponse> {
        ...
        const promise = this.rpc.request('mele.liquidity.v1beta1.Msg', 'CreatePool', data)
    ...
    DepositWithinBatch(request: MsgDepositWithinBatch): Promise<MsgDepositWithinBatchResponse> {
        ...
        const promise = this.rpc.request('mele.liquidity.v1beta1.Msg', 'DepositWithinBatch', data)
    ...
    WithdrawWithinBatch(request: MsgWithdrawWithinBatch): Promise<MsgWithdrawWithinBatchResponse> {
        ...
        const promise = this.rpc.request('mele.liquidity.v1beta1.Msg', 'WithdrawWithinBatch', data)
    ...
    Swap(request: MsgSwapWithinBatch): Promise<MsgSwapWithinBatchResponse> {
        ...
        const promise = this.rpc.request('mele.liquidity.v1beta1.Msg', 'Swap', data)
